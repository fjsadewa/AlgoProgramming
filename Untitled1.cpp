...
//	for(int i=0; i<T; i++){
//		fscanf(fptr, "%lld %*c %s %*c %s %*c %lld %*c %d %*c %d\n",&dat[count].tanggal,&dat[count].name,&cour[count].jenis,&cour[count].Jumlah,&cour[count].Harga,&cour[count].Total);
//	}
	...
	printf ("__________________________________________________________________________________________________\n");
 	printf ("|No|\tTanggal\t|\tNama\t|\tJenis\t|\tproduk\t|\tjumlah\t|\tTotal\t|\n");
 	printf ("__________________________________________________________________________________________________\n");

	for(count = 0; count < T; count++){
 		if(dat[count].tanggal == 3){
 			flag = 1;
 			printf ("|%d |\t %lld\t|\t %s\t|\t %s\t|\t %d\t|\t %lld\t|\n", temp, dat[count].tanggal,dat[count].name,cour[count].jenis,cour[count].Jumlah,cour[count].Total);
			temp++;
	}
}
	printf ("__________________________________________________________________________________________________\n\n");
